...
while running:
    ...
    for badguy in badguys:
        ...
        if badrect.left<64:
            hit.play()# section 6.3.1 after if badrect.left<64:
        ...
        for bullet in arrows:
            ...
            if badrect.colliderect(bullrect):
                enemy.play()# section 6.3.2 after if badrect.colliderect(bullrect):
                acc[0]+=1
                badguys.pop(index)
                arrows.pop(index1)
            index1+=1
    ...
    survivedtext = font.render(
        str(round((90000-pygame.time.get_ticks())/60000))+":"+
    ...
    for event in pygame.event.get():
        ...
        if event.type==pygame.MOUSEBUTTONDOWN:
            shoot.play() # section 8, after if event.type==pygame.MOUSEBUTTONDOWN
            position=pygame.mouse.get_pos()
            acc[1]+=1
